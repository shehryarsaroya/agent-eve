...
const S11F = '## 11F. THE MAP HAS BORDERS — STRAITS, and how far your force reaches';
 ...
 * of fifty-eight could be forgotten. It is in {@link unitGrade}: *a unit one of whose `verbs`
...
const COMMONS_CANNOT_HOLD: ReadonlySet<string> = new Set([
  ...
  // than assume: with the token still here, the Commons row grew **2,891 characters** of §11F for an
 ...
 * was free. At `###` granularity there are fifty-eight: 2^58 is not enumerable, and it
 ...
 * a rule it was given, never for one it was not. There are fifty-eight units; put the same rule
