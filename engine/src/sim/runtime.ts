...
/**
 * ══════════════════════════════════════════════════════════════════════════
 * ★ **38 — THE CREATOR IS TOLD IT HAS TO COUNTERSIGN, AND BY WHEN.**
 *
 ...
 *
 * ── RENUMBERED 39 → 38 AT MERGE ──────────────────────────────────────────────
 *
 * 39 was pre-assigned while two other lanes were in flight and 38 was held for whichever of them
 * landed first. This one landed first, so it takes 38 rather than leaving a hole — per 24's
 * protocol, *pre-assign to avoid the collision, renumber to the tail at merge*, stacked rather than
 * blended. 37 moved `raid`; **38 moves no table at all**, which is why its divergence signature is
