...
describe('the world remembers who built it and who kept their word', () => {
  ...
  it('ties on the same tick break deterministically, never on Map order', () => {
    ...
    // not move.
    const a = { id: 'works:sys-02:5:p:aaa' as never, system: 'sys-02' as never, holder: 'p:aaa' as unknown as PrincipalId, raisedAtTick: 5, onlineAtTick: 29, razed: false, razedAtTick: null, extracted: 0 as never };
